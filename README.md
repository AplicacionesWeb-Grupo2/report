...
|--------------------------|-------------------------|------------------|
| **Reconoce la responsabilidad ética y profesional en el análisis de requerimientos** | Rolando Andre Torres Díaz – Villugas Jerónimo, Liam Anderson <br> **TB1** <br> Participamos en la identificación y documentación de los requerimientos funcionales y no funcionales de *EiraMind*, garantizando que los procesos respeten la confidencialidad y los principios éticos relacionados con la salud mental. Nos aseguramos de que las necesidades del usuario fueran tratadas con sensibilidad y respeto, evitando cualquier sesgo o uso indebido de información personal. | Se evidenció la comprensión de la importancia de la ética en el proceso de desarrollo de software, especialmente al manejar datos sensibles. La aplicación de principios éticos permitió definir requerimientos centrados en el bienestar y la privacidad del usuario, fortaleciendo la integridad del proyecto. |
| **Evalúa el impacto social y humano de las decisiones técnicas en el desarrollo del proyecto** | Rolando Andre Torres Díaz – Villugas Jerónimo, Liam Anderson <br> **TP1** <br> Analizamos cómo cada decisión técnica dentro del sistema (interfaces, flujos y almacenamiento de información) influye en la experiencia del usuario. Propusimos alternativas que priorizan la accesibilidad, el lenguaje empático y la reducción de barreras digitales para pacientes y terapeutas. | Se comprendió que el diseño de un sistema tecnológico debe considerar su impacto en las personas. Incorporar empatía y accesibilidad en las decisiones de diseño favorece la inclusión y fortalece el compromiso ético del ingeniero de software frente a la sociedad. |
